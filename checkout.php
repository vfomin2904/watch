...
<div id="container">
	...
	<div id="content">
		<div id ="title">Оформление заказа</div>
		...
		<div class="field" style="width:100%;text-align:right;">
			...
			<option selected value="1">Курьером (по Москве)</option>
			<option value="2">Почтой России</option>
		   </select><br>
		   <label for="pay">Способ оплаты:</label>
			<select size="1"  name="pay">
			<option selected value="1">Наличными курьеру</option>
			<option value="2">Банковской карточкой</option>
		   </select>
		 </div>
			...
			<div id="address">
				<div class="adr_block">
					...
					<input name="city" type="text" value="Москва" readonly></input>
				</div>
				<div class="adr_block">
				...
				<div class="adr_block">
					<label for="house">Дом, корпус:<sup>*</sup></label>
					<input name="house" type="text"></input>
				</div>
				<div class="adr_block">
					<label for="apartment">Квартира:<sup>*</sup></label>
					<input name="apartment" type="text"></input>
				</div>
				<div class="adr_block">
					<label for="access">Подъезд:<sup>*</sup></label>
				...
				<div class="adr_block" style="display:none;">
					<label for="index">Индекс:<sup>*</sup></label>
					<input name="index" type="text"></input>
				</div>
				<div id="index">
					Чтобы узнать индекс воспользуйтесь <a href="https://www.pochta.ru/offices">поиском отделений</a> Почты России
				</div>
			</div>
			<div id="name">
					<div style="margin-bottom:15px;">Информация о получателе:</div>
					<div class="adr_block" >
		 ...
		 <!-- <iframe frameborder="0" allowtransparency="true" scrolling="no" src="pay.php" width="450" height="198"></iframe>-->
		   <p><input type="submit" value="Оформить заказ" id="checkout"></p>
		</form>
	</div>
</div>
<footer>
