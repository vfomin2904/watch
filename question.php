...
<div id="login">
		<img src="../img/x.png">
		<form id="login_box" action="scripts/authorize.php?href=question.php" style="margin:0 auto" method="POST">
			<h2>Вход на сайт</h2>
			<p>Email:</p>
			<input type="email" name="email" required>
			<p>Пароль:</p>
...
<nav id = "menu">
	<ul>
		...
		<li><img src="../img/support.png"><a href = "question.php" onclick="return false">Задать вопрос</a></li>
	</ul>
</nav>
<div id="container">
	<div id="line">
	...
	<div id="content">
				<form action="send_question.php" style="width:440px; margin:50px auto;">
						<p>Email:</p>
						<input type="email" required>
						<p>Ваш вопрос:</p>
						<textarea rows="10" cols="52" name="text" required></textarea>
