...
<div id="container">
	...
	<div id="content">
		<form id="sendrev_box" action="scripts/send_review.php" method="POST" style="margin:50px auto;width:400px;">
			<p>Email:</p>
			<input type="email" name="email" required>
			<p>Имя:</p>
			<input type="text" name="name" required>
			<p>Ваш отзыв о магазине:</p>
			<textarea rows="10" cols="52"  name="rev_text" style="max-height:200px;max-width:500px;width:500px;height:200px;" required></textarea>
